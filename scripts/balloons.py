...
class Balloons:
    ...
    def __init__(self, game, balloons_images, size, count = 16) -> None:
        ...
        for _ in range(count):
            ...
            speed_y = -(random.random() * 0.05 + 0.05) 
    ...
    def render(self, surf, offset=(0,0)):
        for balloon in self.balloons:
            ...
            if balloon_rect.colliderect(self.game.acrobat.rect()):
                self.game.score += 1
                balloon.pos[0] = self.game.W + random.randrange(10, 100)  # Off-screen to the right
                balloon.pos[1] = random.randrange(0, self.game.H)
